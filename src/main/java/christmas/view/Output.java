...
public class Output {
    ...
    public void showSpecialDiscount(int specialDiscountUnit) {
        ...
        System.out.printf(String.format("%,d", specialDiscountUnit) + WON + LINE);
    }
    ...
    public void showWeekdayDiscount(int discountPrice) {
        ...
        System.out.printf(String.format("%,d", discountPrice) + WON + LINE);
    }
    ...
    public void showGiftMenu() {
        ...
        System.out.println(GIFT + " " + ONE + PER + LINE);
    }

    public void showEventRecord() {
        System.out.println(DISCOUNT_RECORD);
    }
}